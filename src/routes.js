...
const Level = React.lazy(() => import('./views/levels/Levels'))
...
const OrganizationInfo = React.lazy(() => import('./views/organization/OrganizationInfo'))
...
const routes = [
  ...
  { path: '/questions/:id', name: 'Question', element: Question },
  { path: '/organization', name: 'Organization', element: Organization },
  { path: '/organization-info/:id', name: 'Organization Info', element: OrganizationInfo },
